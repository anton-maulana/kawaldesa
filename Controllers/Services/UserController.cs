...
namespace App.Controllers.Services
{
    ...
    public class UserController: ApiController
    {
        ...
        {
            IQueryable<User> exp = dbContext.Set<User>().Where(u => u.IsActive).Include("Roles");           
        ...
        {
            IQueryable<User> exp = dbContext.Set<User>().Include("Roles").Where(u => u.fkOrganizationId.Value == orgId && u.IsActive);           
            return exp.ToList().Select(u => Convert(u));
        }
        ...
        [HttpGet]
        [Authorize]
        public void SetIsActive(String id, bool isActive)
        {
            ModelController<User, string>
                .Update(dbContext, id)

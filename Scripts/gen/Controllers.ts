...
module App.Controllers.Models {
    ...
    export class AccountController
    {
        ...
        public dataModel : App.Models.IAccount = null;
        
        constructor(data?: App.Models.IAccount) {
            this.dataModel = data;
        }
		static GetAll(query?: IQuery): ng.IHttpPromise<Array<App.Models.IAccount>> {
			var res = Microvac.Web.$http<Array<App.Models.IAccount>>(AccountController.ajaxSettings.build({
				method: 'GET',
		...
		static Get(id: number): ng.IHttpPromise<App.Models.IAccount> {
			var res = Microvac.Web.$http<App.Models.IAccount> (AccountController.ajaxSettings.build({
			method: 'GET',
		...
		static Count(query?: IQuery): ng.IHttpPromise<number> {
			var res = Microvac.Web.$http<number>(AccountController.ajaxSettings.build({
				method: 'GET',
        ...
        static GetAccountsByRegion(regionId: string, type: App.Models.AccountType): ng.IHttpPromise<Array<App.Models.IAccount>> {
			var res = Microvac.Web.$http<Array<App.Models.IAccount>>(AccountController.ajaxSettings.build({
			method: 'GET',
			url: '/api/Account/GetAccountsByRegion?regionId='+encodeURI(regionId)+'&type='+type+'',
				}));
			   return res;
	    }
	}
...
module App.Controllers.Services {
    ...
    export class UserController
    {
        ...
        static SetIsActive(id: string, isActive: boolean): ng.IHttpPromise<void> {
			var res = Microvac.Web.$http<void>(UserController.ajaxSettings.build({
			method: 'GET',
			url: '/api/User/SetIsActive?id='+encodeURI(id)+'&isActive='+isActive+'',
				}));
			   return res;
	    }
	}
